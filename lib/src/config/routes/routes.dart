...
import 'package:jollof_express/src/modules/authentication/views/authentication_view.dart';
...
final routes = <String, WidgetBuilder>{
  RouteNames.authenticationPage: (_) => Provider(
        create: (context) => const AuthenticationProvider(),
